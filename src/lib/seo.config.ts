...
export const seoConfig: Record<SeoLocale, LocaleSeoConfig> = {
  ...
  ar: {
    ...
    description:
      "المكان اللي بيجمع أجواء القهوة المختصة والأكل الصحي المتوازن وأكل البيت الدافي تحت سقف واحد. تجربة ضيافة راقية في القاهرة الجديدة مبنية على الجودة والدفء والعيلة.",
    keywords: [
      "قهوة مختصة",
      "أكل صحي",
      "أكل بيتي",
