...
const CinematicFooter = forwardRef<
  HTMLElement,
            ...
            <div className="flex flex-col gap-2">
              {BRANCHES.map((branch) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="font-sans text-xs text-white/60 leading-relaxed hover:text-[#F1E6C3] transition-colors"
                >
          ...
          <div className="film-credit-item flex flex-col space-y-3">
            ...
            <div className="flex flex-col gap-1">
              {BRANCHES.map((branch) => (
                <a
                  ...
                  className="font-mono text-xs text-white/90 hover:text-[#F1E6C3] transition-colors text-start"
                >
                  {tLocations(`${branch.id}.label`)}: {branch.phone}
                </a>
              ))}
            </div>
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="text-white/60 hover:text-[#F1E6C3] transition-colors"
              >
