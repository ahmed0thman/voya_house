...
const TOPICS = [
  { id: "general", label: "General Hello", icon: SparklesIcon, color: "#F1E6C3" },
  { id: "coffee", label: "Coffee Allocation", icon: Coffee01Icon, color: "#F1E6C3" },
  { id: "catering", label: "Papa Wellness Catering", icon: Leaf01Icon, color: "#B7D39A" },
  { id: "events", label: "Mama Family Events", icon: Pizza01Icon, color: "#D8A98F" },
];
      ...
      <div className="max-w-6xl w-full mx-auto relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20 flex flex-col items-center">
          ...
          <h2 className="contact-reveal font-serif text-4xl sm:text-6xl md:text-7xl font-medium tracking-tight text-white leading-tight">
            Join the <span className="text-[#F1E6C3] italic">Voyage.</span>
          </h2>

          <p className="contact-reveal font-sans text-sm sm:text-base text-white/70 max-w-lg mt-4 leading-relaxed">
            Whether you are reserving a table, inquiring about our seasonal bean allocations, or planning a private gathering — our house is always open.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 rounded-[2rem] border border-white/15 bg-gradient-to-b from-white/[0.06] via-white/[0.03] to-transparent p-6 sm:p-8 md:p-10 backdrop-blur-2xl flex flex-col justify-between shadow-2xl relative overflow-hidden">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h3 className="font-serif text-xl font-medium text-white">The House of Voya</h3>
                  <span className="font-mono text-[10px] uppercase tracking-widest text-[#F1E6C3]">Flagship Sanctuary</span>
                </div>
              </div>

              <p className="font-sans text-sm text-white/70 leading-relaxed mb-8">
                Experience the harmony of specialty roasting, mindful nourishment, and generous comfort hospitality.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block font-mono text-[10px] uppercase tracking-widest text-white/50">Address</span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block font-mono text-[10px] uppercase tracking-widest text-white/50">House Hours</span>
                    <p className="font-serif text-sm sm:text-base text-white/90 leading-snug mt-0.5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block font-mono text-[10px] uppercase tracking-widest text-white/50">Concierge Desk</span>
            ...
            <div className="pt-8 mt-8 border-t border-white/10 flex items-center justify-between">
              <span className="font-serif italic text-xs text-white/50">&ldquo;Every sip a new trip.&rdquo;</span>
              <span className="font-mono text-[9px] uppercase tracking-[0.25em] text-[#F1E6C3] font-bold">EST. 2026</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 rounded-[2rem] border border-white/15 bg-gradient-to-b from-white/[0.08] via-white/[0.04] to-black/40 p-6 sm:p-8 md:p-10 backdrop-blur-2xl flex flex-col justify-between shadow-2xl relative">
            ...
            {isSubmitted ? (
              <div className="py-16 flex flex-col items-center text-center justify-center h-full">
                ...
                <h3 className="font-serif text-3xl font-medium text-white mb-2">Message Received</h3>
                <p className="font-sans text-sm text-white/70 max-w-sm mb-8 leading-relaxed">
                  Thank you, <strong className="text-white">{formData.name}</strong>. Our house concierge will be in touch with you shortly.
                </p>
                <button
                  type="button"
                  onClick={() => {
                    ...
                    <div className="flex flex-wrap gap-2">
                      {TOPICS.map((topic) => {
                        ...
                        return (
                          ...
                          >
                            <Icon size={14} className={isSelected ? "text-black" : "text-white/60"} />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label htmlFor="contact-name" className="block font-mono text-[10px] uppercase tracking-widest text-white/60">
                          Your Name
                        </label>
                      ...
                      <div className="space-y-1.5">
                        <label htmlFor="contact-email" className="block font-mono text-[10px] uppercase tracking-widest text-white/60">
                          Email Address
                        </label>
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-white/[0.04] hover:bg-white/[0.06] focus:bg-white/[0.08] border border-white/15 focus:border-[#F1E6C3] rounded-2xl py-3.5 pl-11 pr-4 text-sm text-white placeholder-white/25 outline-none transition-all duration-300 focus:shadow-[0_0_20px_rgba(241,230,195,0.15)]"
                          />
                          <Mail01Icon size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40 pointer-events-none" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5 pt-1">
                      <label htmlFor="contact-message" className="block font-mono text-[10px] uppercase tracking-widest text-white/60">
                      ...
                      <div className="relative">
                        ...
                        />
                        <Message01Icon size={16} className="absolute left-4 top-4 text-white/40 pointer-events-none" />
                      </div>
                    </div>
                  </div>
                </div>
