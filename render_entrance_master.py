...
def render_scene1_master(output_dir="public/assets/frames", total_frames=78):
    os.makedirs(output_dir, exist_ok=True)
    
    # Load master composite (1282 x 2279)
    entrance_img = cv2.imread("public/assets/3d-renders/entrance_master_wide.jpg")
    h_img, w_img, _ = entrance_img.shape
    out_w, out_h = 720, 1280
    
    print(f"Master input size: {w_img}x{h_img}")
    
    # Door coordinates in master image (1282 x 2279)
    door_outer_x1, door_outer_x2 = 391, 612
    door_outer_y1, door_outer_y2 = 1928, 2202
    
    door_inner_y1 = 1944
    door_inner_y2 = 2196
    door_left_hinge = 402
    door_center_seam = 502
    door_right_hinge = 602
    ...
    print(f"Rendered all {total_frames} master frames into {output_dir} successfully!")

if __name__ == "__main__":
    render_scene1_master()
